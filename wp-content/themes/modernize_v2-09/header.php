...
<head>
  ...
  ================================================== -->
	...
	<script type="text/JavaScript">
	    var _ibp_public_key = "be3b29691d106d9040bd0c7726dd79db81f3f267";
	    var _ibp_formatting = true;
	    var _ibp_keyword_set = 38811;
	</script>
  ...
  ================================================== -->
	...
	<?php if( $gdl_is_responsive ){ ?>
		...
		<link rel="stylesheet" href="<?php echo GOODLAYERS_PATH; ?>/claymoredesign.css">	
	<?php }else{ ?>
